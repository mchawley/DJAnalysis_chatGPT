...
const previewStyle=document.createElement('style');previewStyle.textContent='.segment-actions.segment-controls{justify-content:space-between;padding:12px;background:#10182a;border-radius:10px}.segment-control-group{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.segment-control-group.preview-group{margin-left:auto}.control-label{color:#9aa6bf;font-size:12px;text-transform:uppercase;letter-spacing:.08em}.preview-status{color:#9aa6bf;font-size:12px;min-width:145px}.loop-control{display:flex;align-items:center;gap:6px;color:#9aa6bf;font-size:13px}.loop-control input{width:auto;padding:0}@media(max-width:850px){.segment-actions.segment-controls,.segment-control-group.preview-group{justify-content:flex-start;margin-left:0;width:100%}}';document.head.append(previewStyle);
