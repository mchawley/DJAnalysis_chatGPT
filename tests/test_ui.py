...
class InsightsHandlerTest(unittest.TestCase):
    ...
    def test_playlist_ui_uses_separate_smoothed_charts_and_real_badge_labels(self):
        ...
        self.assertIn("function trackDurations", PLAYLIST_HTML)
    ...
    def test_playlist_ui_uses_phase_a_colored_segment_strips_without_global_flow(self):
        ...
        self.assertIn("function trackMarkers", PLAYLIST_HTML)
        self.assertIn("stroke-dasharray=\"3 4\"", PLAYLIST_HTML)
        self.assertIn("function clock", PLAYLIST_HTML)
        self.assertIn("track.trackDuration", PLAYLIST_HTML)
        self.assertIn("/480", PLAYLIST_HTML)
        self.assertIn('class="track-side"', PLAYLIST_HTML)
